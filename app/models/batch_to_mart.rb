class BatchToMart < ActiveRecord::Base
  ...
  def self.batch_transform_retail(month, year)
    ActiveRecord::Base.connection.execute("
      REPLACE INTO sales_martBU.RET1BRAND (AREA, branch, cabang_id, brand,  fiscal_day, fiscal_month, fiscal_year, sales_quantity, sales_amount, updated_at)
    ...
    ActiveRecord::Base.connection.execute("
      REPLACE INTO sales_martBU.RET1PRODUCT (AREA, branch, cabang_id, brand, product, sales_quantity, sales_amount,
    ...
    ActiveRecord::Base.connection.execute("
    REPLACE INTO sales_martBU.RET1ARTICLE (AREA, branch, cabang_id, brand, product, article, article_desc, size, sales_quantity, sales_amount,
        fiscal_day, fiscal_month, fiscal_year, updated_at)
    ...
    ActiveRecord::Base.connection.execute("
    REPLACE INTO sales_martBU.RET2CUSBRAND (AREA, branch, cabang_id, brand, customer, customer_desc, sales_quantity, sales_amount, fiscal_day, fiscal_month, fiscal_year, updated_at)
      SELECT area_id, area_id, cabang_id, jenisbrgdisc, kode_customer, customer, SUM(jumlah), SUM(harganetto2), DAY(tanggalsj), fiscal_month, fiscal_year, NOW()
            FROM dbmarketing.tblaporancabang WHERE jenisbrgdisc != ' ' AND area_id IS NOT NULL AND tipecust = 'RETAIL'
    ...
    ActiveRecord::Base.connection.execute("
    REPLACE INTO sales_martBU.RET2CUSPRODUCT (AREA, branch, cabang_id, brand, customer, customer_desc, product, sales_quantity, sales_amount,
        fiscal_day, fiscal_month, fiscal_year, updated_at)
    ...
    ActiveRecord::Base.connection.execute("
    REPLACE INTO sales_martBU.RET2CUSARTICLE (AREA, branch, cabang_id, brand, customer, customer_desc, product, article, article_desc, size, sales_quantity, sales_amount,
        fiscal_day, fiscal_month, fiscal_year, updated_at)
    ...
    ActiveRecord::Base.connection.execute("
    REPLACE INTO sales_martBU.RET3SALBRAND (AREA, branch, cabang_id, brand, salesmen, salesmen_desc, sales_quantity, sales_amount, fiscal_day, fiscal_month, fiscal_year, updated_at)
    ...
    ActiveRecord::Base.connection.execute("
    REPLACE INTO sales_martBU.RET3SALPRODUCT (AREA, branch, cabang_id, brand, salesmen, salesmen_desc, product, sales_quantity, sales_amount,
        fiscal_day, fiscal_month, fiscal_year, updated_at)
    ...
    ActiveRecord::Base.connection.execute("
    REPLACE INTO sales_martBU.RET3SALARTICLE (AREA, branch, cabang_id, brand, salesmen, salesmen_desc, product, article, article_desc, size, sales_quantity, sales_amount,
        fiscal_day, fiscal_month, fiscal_year, updated_at)
    ...
    ActiveRecord::Base.connection.execute("
    REPLACE INTO sales_martBU.RET4CITYBRAND (AREA, branch, cabang_id, brand, city, sales_quantity, sales_amount, fiscal_day, fiscal_month, fiscal_year, updated_at)
      SELECT area_id, area_id, cabang_id, jenisbrgdisc, kota, SUM(jumlah), SUM(harganetto2), DAY(tanggalsj), fiscal_month, fiscal_year, NOW()
            FROM dbmarketing.tblaporancabang WHERE jenisbrgdisc != ' ' AND area_id IS NOT NULL AND tipecust = 'RETAIL' AND nopo IS NOT NULL
            AND fiscal_month = '#{month}' AND fiscal_year = '#{year}' GROUP BY DAY(tanggalsj), fiscal_month, fiscal_year, cabang_id, area_id, jenisbrgdisc, nopo;")

    ActiveRecord::Base.connection.execute("
    REPLACE INTO sales_martBU.RET4CITYPRODUCT (AREA, branch, cabang_id, brand, city, product, sales_quantity, sales_amount,
        fiscal_day, fiscal_month, fiscal_year, updated_at)
    ...
    ActiveRecord::Base.connection.execute("
    REPLACE INTO sales_martBU.RET4CITYARTICLE (AREA, branch, cabang_id, brand, city, product, article, article_desc, size, sales_quantity, sales_amount,
        fiscal_day, fiscal_month, fiscal_year, updated_at)
