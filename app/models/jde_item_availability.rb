class JdeItemAvailability < ActiveRecord::Base
  ...
  def self.historical_stock
    us = self.find_by_sql("SELECT NVL(ST.LIMCU,0) AS STOCK_BRANCH, NVL(IL.ILMCU,0) AS TRANSACTION_BRANCH, 
      ...
      NVL(SUM(ST.LIPQOH),0) AS STOCK,
      MAX(IM.IMPRGR) AS BRAND,
      MAX(IM.IMITM) AS SHORT FROM PRODDTA.F0006 MC
      LEFT JOIN
      (
        SELECT IBITM, IBMCU FROM PRODDTA.F4102
      ) IB ON IB.IBMCU = MC.MCMCU
      LEFT JOIN
      (
        SELECT IMITM, IMTMPL, IMPRGR, IMDSC1, IMDSC2, IMLITM, IMSTKT FROM PRODDTA.F4101 WHERE IMTMPL LIKE '%BJ MATRASS%' AND IMSTKT != 'O'
      ) IM ON IM.IMITM = IB.IBITM
      LEFT JOIN 
      (
          SELECT LIMCU, SUM(LIPQOH/10000) AS LIPQOH, LIITM AS LIITM FROM PRODDTA.F41021 GROUP BY LIMCU, LIITM
      ) ST ON IM.IMITM = ST.LIITM AND MC.MCMCU = ST.LIMCU
      LEFT JOIN 
      (
      ...
      WHERE MC.MCRP05 LIKE '510' AND IL.QTYIN >= 0 OR IL.QTYOUT < 1 OR IL.ADJIN >= 1 OR IL.ADJOUT < 1 OR ST.LIPQOH > 0 GROUP BY IM.IMITM, ST.LIMCU, IL.ILMCU")
    us.each do |fus|
      ...
      item_number, brand, stock, out_stock, in_stock, adj_in, adj_out, branch_id, branch_desc, transaction_date,
      short_item, created_at, updated_at, fday, fmonth, fyear) VALUES 
        ('#{fus.stock_branch.strip}', '#{fus.description}',
        '#{fus.kode}', '#{fus.brand}', '#{fus.stock}', 
  ...
  def self.jde_cabang(bu)
    if bu.include?('11002') || bu == "11001" || bu == "11001D" || bu == "11001C" || bu == "11001S" || bu == "18001" #pusat
      "01"
    elsif bu == "11101" || bu == "11102" || bu == "11101C" || bu == "11101D" || bu == "11101S" || bu == "18101" || bu == "18101C" || bu == "18101D" || bu == "18102" || bu == "18101S" || bu == "18101K" #lampung
      "13" 
    elsif bu.include?('13011') || bu.include?('11011') || bu == "18011" || bu == "18011C" || bu == "18011D" || bu == "18012" || bu == "18011S" || bu == "18011K" #jabar
      "02"
      ...
      "23"
    elsif bu.include?('11031') || bu == "11030" || bu == "18031" || bu == "18031C" || bu == "18031D" || bu == "18032" || bu == "18031S" || bu == "18031K" #narogong
      "03"
    elsif bu == "13111D" || bu == "13111S" || bu == "12111" || bu == "12112" || bu == "12111C" || bu == "12111D" || bu == "12111S" || bu == "18111" || bu == "18111C" || bu == "18111D" || bu == "18112" || bu == "18111S" || bu == "18111K" || bu == "18112C" || bu == "18112D" || bu == "18112K" #makasar
      "19"
      ...
      "11"
    elsif bu.include?('18041') || bu.include?('13041') || bu == "11041" || bu == "11042" || bu == "11041C" || bu == "11041D" || bu == "11041S" || bu == "18041" || bu == "18041C" || bu == "18041D" || bu == "18042" || bu == "18042S" || bu == "18042K" || bu == "18042C" || bu == "18042D" || bu == "18042K" #yogyakarta
      "10"
      ...
      "05"
    elsif bu.include?('12112') || bu == "11121" || bu == "11122" || bu == "11121C" || bu == "11121D" || bu == "11121S" || bu == "18121" || bu == "18121C" || bu == "18121D" || bu == "18122" || bu == "18121S" || bu == "18121K" || bu == "18122C" || bu == "18122D" || bu == "18122K" #pekanbaru
      "20"
