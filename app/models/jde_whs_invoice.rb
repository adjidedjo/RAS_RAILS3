class JdeWhsInvoice < ActiveRecord::Base
  ...
  def self.import_sales(date)
    invoices = find_by_sql("SELECT SA.RPLNID AS LINEFAKTUR, SA.RPDOC AS NOFAKTUR, SA.RPDCT AS ORTY, SA.RPSDOC AS NOSO, SA.RPSDCT AS DOC, SA.RPSFX AS LINESO, 
       ...
       (
         ...
         AND REGEXP_LIKE(RPMCU,'1800211|1800212|11003|11012')
       ) SA
       LEFT JOIN
       (
  ...
  def self.jde_cabang(bu)
    if bu == "11001" || bu == "11001D" || bu == "11001C" || bu == "18001" || bu == "11002S" || bu == "11002" || bu == "11003" || bu == "1800211" #pusat
      "01"
      ...
      "09"
    elsif bu == "12001" || bu == "12002" || bu == "12001C" || bu == "12001D" || bu == "1800212" #bestari mulia
      "50"
