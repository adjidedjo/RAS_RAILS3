class Pdc::OutstandingProduction < ActiveRecord::Base
  ...
  def self.generate_outstanding_stock
    self.all.each do |op|
      ...
      so_outstanding = Pdc::OutstandingOrder.find_by_short_item_and_branch(op.short_item, op.branch)
      ...
      op.update_attributes!(outstanding_order: so_outstanding.quantity, segment1: so_outstanding.segment1) if so_outstanding
